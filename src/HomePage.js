...
const HomePage = (props) => {
    ...
    <div className="App">
      ...
      <div style={{ display: "flex", justifyContent: "space-evenly" }}>
       <div>
         ...
         {planets  ?
      <div>
      <select value={firstPlanetDistance}  onChange = {(evt) => {setFirstPlanetDistance(evt.target.value) ; setClickedFirst(true); setFalconeFound( falconeFound ? true : ((evt.target.value/100)-1) === props.falcone) }}>
  ...
  {clickedFirst ? <form >
    ...
    : ""}
         ...
         {planets  ?
      <div>
      <select value={secondPlanetDistance} onChange = {(evt) => {setSecondPlanetDistance(evt.target.value);setClickedSecond(true) ; setFalconeFound(falconeFound ? true : ((evt.target.value/100)-1) === props.falcone)}}>
  <option>select</option>
  ...
  {clickedSecond ? <form >
    ...
    : ""}
         ...
         {planets  ?
      <div>
      <select value={thirdPlanetDistance} onChange = {(evt) => {setThirdPlanetDistance(evt.target.value); setClickedThird(true); setFalconeFound( falconeFound ? true : ((evt.target.value/100)-1) === props.falcone)}}>
  <option>select</option>
  ...
  {clickedthird ? <form >
    ...
    : ""}
         ...
         {planets  ?
      <div>
      <select value={fourthPlanetDistance}  onChange = {(evt) => {setFourthPlanetDistance(evt.target.value); setClickedFourth(true); setFalconeFound( falconeFound ? true : ((evt.target.value/100)-1) === props.falcone)}}>
  <option>select</option>
